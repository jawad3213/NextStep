  ...
  template: `
    <div class="shell-container">
      <header class="page-header">
        <h1 class="page-title">Email & Lettre</h1>
        <p class="page-description">Aperçu email généré, lettre de motivation, statut d'envoi.</p>
      </header>
      <div class="placeholder-card">✉️ Section Email & Lettre en cours de développement...</div>
    </div>
  `,
