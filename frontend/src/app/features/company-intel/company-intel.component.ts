  ...
  template: `
    <div class="shell-container">
      <header class="page-header">
        ...
        <p class="page-description">Fiche entreprise, salaires, culture score, actualités.</p>
      </header>
      <div class="placeholder-card">🏢 Section Company Intel en cours de développement...</div>
    </div>
  `,
