  ...
  template: `
    <div class="shell-container">
      <header class="page-header">
        ...
        <p class="page-description">Compte, connexion Gmail OAuth, connexion LinkedIn, préférences.</p>
      </header>
      <div class="placeholder-card">⚙️ Section Paramètres en cours de développement...</div>
    </div>
  `,
