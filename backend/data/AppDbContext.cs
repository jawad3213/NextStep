...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SourcedOffer>(entity =>
        {
            ...
            entity.Property(e => e.AiScoreSkills).HasColumnName("ai_score_skills");
            entity.Property(e => e.AiScoreTitle).HasColumnName("ai_score_title");
            entity.Property(e => e.AiScoreLocation).HasColumnName("ai_score_location");
            entity.Property(e => e.AiScoreContract).HasColumnName("ai_score_contract");
            entity.Property(e => e.AiScoreFreshness).HasColumnName("ai_score_freshness");
            entity.Property(e => e.AiConfidence).HasColumnName("ai_confidence");
            entity.Property(e => e.AiMatchedSkillsJson).HasColumnName("ai_matched_skills_json").HasColumnType("jsonb").HasDefaultValue("[]");
            entity.Property(e => e.AiMissingSkillsJson).HasColumnName("ai_missing_skills_json").HasColumnType("jsonb").HasDefaultValue("[]");
            entity.Property(e => e.AiReasonsJson).HasColumnName("ai_reasons_json").HasColumnType("jsonb").HasDefaultValue("[]");
            entity.Property(e => e.AiSummary).HasColumnName("ai_summary").HasMaxLength(500);
            entity.Property(e => e.AiRankedAtUtc).HasColumnName("ai_ranked_at_utc");
