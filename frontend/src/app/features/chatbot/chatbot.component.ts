  ...
  template: `
    <div class="shell-container">
      <header class="page-header">
        <h1 class="page-title">Chatbot Entretien</h1>
        <p class="page-description">Mock interview, questions spécifiques, feedback STAR.</p>
      </header>
      <div class="placeholder-card">🤖 Section Chatbot IA en cours de développement...</div>
    </div>
  `,
