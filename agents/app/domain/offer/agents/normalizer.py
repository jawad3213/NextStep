# ============================================================
# app/domain/offer/agents/normalizer.py
...
# Clé = forme alternative → Valeur = forme canonique
SYNONYMES: dict[str, str] = {
    ...
    # Méthodo
    "agile scrum": "scrum", "methode agile": "agile",
}
...
def normalize_text(text: str) -> str:
    ...
    Returns:
        Texte normalisé en minuscules sans accents
    """
...
async def normalizer_node(state: OfferState) -> dict:
    ...
    Notes LangGraph :
      - Les champs Annotated[list, operator.add] sont ACCUMULÉS.
      - Retourner une liste ici = l'ajouter à la liste existante.
      - profile_full_text est scalaire → remplacé.
    """
