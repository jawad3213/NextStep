  ...
  template: `
    <div class="shell-container">
      <header class="page-header">
        ...
        <p class="page-description">Account, Gmail OAuth connection, LinkedIn connection, preferences.</p>
      </header>
      <div class="placeholder-card">⚙️ Settings section under development...</div>
    </div>
  `,
