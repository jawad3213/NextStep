  ...
  template: `
    <div class="shell-container">
      <header class="page-header">
        ...
        <p class="page-description">Alertes relance J+7, nouvelles offres, réponses Gmail.</p>
      </header>
      <div class="placeholder-card">🔔 Section Notifications en cours de développement...</div>
    </div>
  `,
