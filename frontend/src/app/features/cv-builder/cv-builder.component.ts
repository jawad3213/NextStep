  ...
  template: `
    <div class="shell-container">
      <header class="page-header">
        ...
        <p class="page-description">Sélection de template, aperçu PDF, score ATS, historique des versions.</p>
      </header>
      <div class="placeholder-card">📄 Section CV en cours de développement...</div>
    </div>
  `,
