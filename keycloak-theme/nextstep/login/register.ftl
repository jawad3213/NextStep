        ...
        <#if realm.password>
            <div id="kc-social-providers">
                <div class="social-providers">
                    <a href="${url.registrationAction}&kc_idp_hint=google" class="btn-social" id="social-google">
                    ...
                    <a href="${url.registrationAction}&kc_idp_hint=github" class="btn-social" id="social-github">
