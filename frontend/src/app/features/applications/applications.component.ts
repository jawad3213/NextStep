  ...
  template: `
    <div class="shell-container">
      <header class="page-header">
        ...
        <p class="page-description">Kanban tracker (Sent → Viewed → Interview → Offer → Rejected).</p>
      </header>
      <div class="placeholder-card">📋 Applications section (Kanban) under development...</div>
    </div>
  `,
